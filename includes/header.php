<div class="header_section">
    ...
    <div class="banner_section layout_padding">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <!-- <h1 class="banner_taital">Your Trusted Cleaning Solution</h1> -->
                    <h1 class="banner_taital_1">Soap and steam</h1>
                ...
                <div class="col-sm-2">
                    <div class="play_icon"><a target="_blank" href="https://youtube.com"><img src="images/play-icon.png"></a></div>
                </div>
                <div class="col-sm-5">
